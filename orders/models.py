...
class Order(models.Model):
    ...
    total_price = models.DecimalField(max_digits=10, decimal_places=2, default=0)  #total price fpr all products in order
    ...
    def __str__(self):
        return "Your Order %s %s" % (self.id, self.status.name)
...
class ProductInOrder(models.Model):
    ...
    is_active = models.BooleanField(default=True) #models.ForeignKey(Status, on_delete=models.CASCADE)
